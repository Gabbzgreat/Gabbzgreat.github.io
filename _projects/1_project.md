...
Using **YOLOv8n, YOLOv8s, and YOLOv8m**, the system performs fast multi-class object detection suitable for automated inspection in manufacturing workflows.

Models were trained on a curated subset of the RF100 PCB dataset and evaluated across precision, recall, mAP, F1 curves, and confusion matrices.

---

## 🔵 Prediction Examples (YOLOv8n / s / m)
...
This perception pipeline demonstrates:

- Advanced object detection mechanisms  
- Real-time inference optimization  
- Dataset engineering & augmentation  
- Evaluation across multiple vision metrics  
- API-ready deployment for robotic inspection systems  

These skills transfer directly to robotic scene understanding, visual servoing, and autonomous inspection.
